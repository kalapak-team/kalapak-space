          ...
          <div class="relative bg-white/95 dark:bg-dark-900/95 backdrop-blur-2xl shadow-2xl shadow-black/25 ring-1 ring-gray-200/80 dark:ring-white/[0.08] rounded-2xl overflow-hidden">
            ...
            <div class="flex items-center gap-1 px-5 sm:px-6 pb-3 border-b border-gray-100 dark:border-white/[0.06]">
              <button
                ...
                class="search-filter-btn inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-semibold tracking-wide uppercase transition-all duration-200"
              ...
              <div v-else-if="filteredResults.length" class="p-2 sm:p-3">
                ...
                <div v-if="filteredProjects.length" class="mb-2">
                  ...
                  <router-link
                    ...
                    class="search-result-item group flex items-center gap-3 px-3 py-2.5 rounded-full transition-all duration-150 cursor-pointer"
                  ...
                  >
                    <!-- Thumbnail -->
                    <div class="relative w-10 h-10 rounded-full overflow-hidden shrink-0 ring-1 ring-gray-200/60 dark:ring-white/[0.06]">
                ...
                <div v-if="filteredDocs.length">
                  ...
                  >
                    <div class="w-10 h-10 rounded-full bg-gray-100/80 dark:bg-white/[0.04] flex items-center justify-center shrink-0">
              ...
              <div v-else-if="query.length < 2 && !loading" class="p-2 sm:p-3">
                ...
                <div v-if="recentSearches.length" class="mb-3">
                  ...
                  <button
                    ...
                    :key="'r' + i"
                    class="search-result-item group flex items-center gap-3 w-full px-3 py-2.5 rounded-full transition-all duration-150 text-left"
                    :class="activeIndex === i
                      ? 'bg-brand-violet/8 dark:bg-brand-cyan/8 ring-1 ring-brand-violet/15 dark:ring-brand-cyan/15'
                      : 'hover:bg-gray-50 dark:hover:bg-white/[0.03]'"
                  ...
                  >
                    <div class="w-8 h-8 rounded-full bg-gray-100/80 dark:bg-white/[0.04] flex items-center justify-center shrink-0">
                ...
                <div>
                  ...
                  <div class="grid grid-cols-2 gap-1.5">
                    <router-link
                      ...
                      :key="'q' + i"
                      :to="link.to"
                      class="search-quick-link group flex items-center gap-2.5 px-3 py-3 rounded-full transition-all duration-150"
                    ...
                    >
                      <div class="w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-colors duration-150"
                           :class="activeIndex === getQuickLinkIndex(i)
