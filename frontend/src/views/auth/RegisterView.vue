<template>
  <div>
    ...
    <form @submit.prevent="handleRegister" class="space-y-5">
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            type="text"
            required
            class="w-full pl-12 pr-4 py-3.5 bg-dark-800/80 border border-dark-600 rounded-full text-white placeholder-gray-500 focus:outline-none focus:border-brand-violet focus:ring-1 focus:ring-brand-violet/50 transition-all"
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            class="w-full pl-10 pr-4 py-3.5 bg-dark-800/80 border border-dark-600 rounded-full text-white placeholder-gray-500 focus:outline-none focus:border-brand-violet focus:ring-1 focus:ring-brand-violet/50 transition-all"
      ...
      <div>
        ...
        <div class="relative">
          ...
          <input
            ...
            required
            minlength="8"
            class="w-full pl-12 pr-12 py-3.5 bg-dark-800/80 border border-dark-600 rounded-full text-white placeholder-gray-500 focus:outline-none focus:border-brand-violet focus:ring-1 focus:ring-brand-violet/50 transition-all"
      ...
      <!-- Error -->
      <div v-if="error" class="flex items-center gap-3 px-4 py-3 rounded-full bg-red-500/10 border border-red-500/20">
      ...
      <button
        ...
        class="relative w-full py-3.5 rounded-full font-semibold text-white overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed transition-all"
      >
    ...
    <div class="grid grid-cols-2 gap-3">
      <button
        ...
        class="flex items-center justify-center gap-2.5 px-4 py-3 rounded-full bg-dark-800/60 border border-dark-600 text-gray-300 hover:bg-dark-700 hover:border-dark-500 transition-all group"
      >
