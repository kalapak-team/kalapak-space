  ...
  <div class="about-page">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div data-aos="fade-right">
            ...
            >
              <p>
                Kalapak Code Team was founded by a group of Year-4 IT
                engineering students at the Norton University. United by the
                shared vision of using technology to create positive impact, we
                came together to build real-world projects, learn from each
                other, and contribute to the Cambodian tech ecosystem.
              </p>
              <p>
                Our name
                <strong class="text-gray-900 dark:text-white"
                  >"Kalapak" (កលាបៈ)</strong
                >
                reflects our mission: to package knowledge and deliver it
                through code. From web applications to mobile apps, we tackle
                challenges with a cosmic-level ambition.
              </p>
            </div>
            <!-- Mini stats -->
            <div class="grid grid-cols-3 gap-4 sm:gap-6 mt-8 sm:mt-10">
              <div v-for="(s, i) in miniStats" :key="i">
                <p
                  class="text-xl sm:text-2xl md:text-3xl font-sans font-bold gradient-text"
                >
                  {{ s.value }}
                </p>
                <p
                  class="text-xs text-gray-500 dark:text-gray-400 mt-1 uppercase tracking-wider"
                >
                  {{ s.label }}
                </p>
              </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <h3
              class="text-xl font-sans font-bold text-gray-900 dark:text-white mb-3"
            >
              Our Mission
            </h3>
            <p class="text-gray-700 dark:text-gray-400 leading-relaxed mb-4">
              Learning to be a pillar for one another, as we strive to become a
              leading student-driven tech team, inspiring the next generation of
              Cambodian developers and proving that world-class software can be
              built anywhere through:
            </p>
            <ul class="space-y-2">
              <li
                class="flex items-start gap-2 text-gray-700 dark:text-gray-400 text-sm"
              >
                <span
                  class="mt-0.5 text-brand-violet dark:text-brand-cyan font-bold shrink-0"
                  >💎</span
                >
                <span
                  ><span class="font-semibold text-gray-800 dark:text-gray-200"
                    >Common Thinking</span
                  >
                  – Harnessing collective wisdom to solve complex
                  problems.</span
                >
              </li>
              <li
              ...
              >
                ...
                <span
                  ><span class="font-semibold text-gray-800 dark:text-gray-200"
                    >Common Action</span
                  >
                  – Working in unity to transform ideas into reality.</span
                >
              </li>
              <li
                class="flex items-start gap-2 text-gray-700 dark:text-gray-400 text-sm"
              >
                ...
                <span
                  ><span class="font-semibold text-gray-800 dark:text-gray-200"
                    >Common Responsibility</span
                  >
                  – Standing together for every outcome we deliver.</span
                >
              </li>
            </ul>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid md:grid-cols-3 gap-6 sm:gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <h3
              class="text-lg font-sans font-bold text-gray-900 dark:text-white mb-3"
            >
              Common Thinking
            </h3>
            <p class="text-gray-700 dark:text-gray-400 leading-relaxed text-sm">
    ...
    <section class="py-14 sm:py-18 lg:py-24 relative overflow-hidden">
      ...
      >
        ...
        <div
          class="team-orbit-ring absolute w-[300px] sm:w-[500px] h-[300px] sm:h-[500px]"
        >
        ...
        <!-- Middle ring -->
        <div
          class="team-orbit-ring-reverse absolute w-[450px] sm:w-[750px] h-[450px] sm:h-[750px]"
        >
          <svg class="w-full h-full" viewBox="0 0 750 750" fill="none">
            ...
            />
            <defs>
              <linearGradient id="grad2" x1="0" y1="0" x2="750" y2="750">
        ...
        <!-- Outer ring -->
        <div
          class="team-orbit-ring absolute w-[600px] sm:w-[1000px] h-[600px] sm:h-[1000px]"
        ...
        >
          <svg class="w-full h-full" viewBox="0 0 1000 1000" fill="none">
            ...
            />
            <defs>
              <linearGradient id="grad3" x1="0" y1="0" x2="1000" y2="1000">
                <stop offset="0%" stop-color="#7b2fff" />
                <stop offset="100%" stop-color="#00d4ff" />
              </linearGradient>
            </defs>
        ...
        <!-- Center glow -->
        <div
          class="absolute w-40 h-40 rounded-full bg-brand-violet/5 blur-[80px]"
        />
      </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        <div class="text-center mb-10 sm:mb-16" data-aos="fade-up">
          ...
          <p
            class="text-gray-500 dark:text-gray-400 mt-4 max-w-lg mx-auto text-sm leading-relaxed"
          >
            Every great product is built by great people. Here's the crew behind
            Kalapak.
          </p>
        </div>

        <div
          class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8"
        >
          <div
          ...
          >
            ...
            >
              ...
              <div
                class="relative w-20 h-20 sm:w-28 sm:h-28 lg:w-36 lg:h-36 mx-auto mb-3 sm:mb-4 lg:mb-6"
              >
                <!-- Outer orbit circle with traveling dots -->
                <div
                  class="absolute inset-[-16px] rounded-full team-avatar-orbit opacity-40 group-hover:opacity-100 transition-opacity duration-700"
                >
                ...
                <div
                  class="absolute inset-[-4px] rounded-full team-avatar-ring opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                />
                <div
                  class="absolute inset-[-7px] rounded-full team-avatar-ring-outer opacity-0 group-hover:opacity-60 transition-opacity duration-700"
                />
                <!-- Multi-layer glow -->
                <div
                  class="absolute inset-[-12px] rounded-full bg-brand-cyan/10 blur-2xl opacity-0 group-hover:opacity-80 transition-opacity duration-700 team-glow-pulse"
                />
                <div
                  class="absolute inset-[-20px] rounded-full bg-brand-violet/8 blur-3xl opacity-0 group-hover:opacity-60 transition-opacity duration-1000"
                />
                <!-- Avatar circle -->
                <div
                  class="relative w-20 h-20 sm:w-28 sm:h-28 lg:w-36 lg:h-36 rounded-full overflow-hidden ring-[3px] ring-gray-200/40 dark:ring-dark-500/40 group-hover:ring-0 transition-all duration-500 z-10"
                >
                  <img
                    v-if="member.avatar"
                    :src="member.avatar"
                  ...
                  <div
                    v-else
                    class="w-full h-full bg-gradient-brand flex items-center justify-center text-white text-3xl font-sans font-bold"
                  >
                ...
                <div
                  class="absolute inset-[-6px] rounded-full team-orbit-dot opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                >
                  <span
                    class="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-brand-cyan shadow-[0_0_12px_rgba(0,212,255,0.9)]"
                  />
                </div>
                <div
                  class="absolute inset-[-6px] rounded-full team-orbit-dot-reverse opacity-0 group-hover:opacity-100 transition-opacity duration-700"
                >
                  <span
                    class="absolute bottom-0 left-1/2 -translate-x-1/2 translate-y-1/2 w-1.5 h-1.5 rounded-full bg-brand-violet shadow-[0_0_10px_rgba(123,47,255,0.9)]"
                  />
                </div>
                <!-- Corner sparkles -->
                <span
                  class="absolute -top-2 -right-2 w-1 h-1 rounded-full bg-brand-cyan opacity-0 group-hover:opacity-100 team-sparkle"
                  style="animation-delay: 0s"
                />
                <span
                  class="absolute -bottom-1 -left-3 w-1.5 h-1.5 rounded-full bg-brand-violet opacity-0 group-hover:opacity-100 team-sparkle"
                  style="animation-delay: 0.4s"
                />
                <span
                  class="absolute top-4 -left-4 w-1 h-1 rounded-full bg-brand-cyan opacity-0 group-hover:opacity-100 team-sparkle"
                  style="animation-delay: 0.8s"
                />
                <!-- Founder badge -->
                <div
                  v-if="member.is_founder"
                  class="absolute -bottom-2 left-1/2 -translate-x-1/2 z-20 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-gradient-brand text-white shadow-glow whitespace-nowrap team-badge-float"
                >
                  Founder
                </div>
              </div>
              ...
              <!-- Info -->
              <h3
                class="text-sm sm:text-base lg:text-lg font-sans font-bold text-gray-900 dark:text-white mb-0.5 sm:mb-1 transition-all duration-500 group-hover:text-brand-cyan"
              >
                {{ member.name }}
              </h3>
              <p
                class="text-xs sm:text-sm text-brand-violet dark:text-brand-cyan mb-2 sm:mb-3 font-semibold transition-all duration-300"
              >
                {{ member.title || member.role }}
              </p>
              <p
                class="text-[10px] sm:text-xs text-gray-700 dark:text-gray-400 leading-relaxed mb-3 sm:mb-5 line-clamp-2 sm:line-clamp-3 transition-all duration-500 group-hover:text-gray-800 dark:group-hover:text-gray-300"
              >
              ...
              <div
                class="absolute bottom-0 left-1/2 -translate-x-1/2 h-[2px] w-0 group-hover:w-3/4 bg-gradient-to-r from-transparent via-brand-cyan to-transparent transition-all duration-700 rounded-full"
              />
            </div>
          </div>
        </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          ...
          >
            ...
            <div
              class="absolute bottom-0 left-0 right-0 h-[2px] bg-gradient-brand opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-b-2xl"
            />
          </div>
        </div>
      </div>
    ...
    <section class="py-14 sm:py-18 lg:py-24 relative overflow-hidden">
      ...
      <div class="absolute inset-0 pointer-events-none">
        <span
          v-for="p in 12"
          :key="p"
          class="tl-particle absolute rounded-full bg-brand-violet/20 dark:bg-brand-cyan/20"
          :style="{
            width: 4 + (p % 3) * 3 + 'px',
            height: 4 + (p % 3) * 3 + 'px',
            left: ((p * 8.3) % 100) + '%',
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6">
        ...
        <div class="relative">
          ...
          <div
            class="absolute left-6 md:left-1/2 md:-translate-x-px top-0 bottom-0 w-0.5 overflow-hidden"
          >
            <div
              class="tl-line-fill w-full h-full bg-gradient-to-b from-brand-violet via-brand-cyan to-brand-violet/20"
            />
            <!-- Traveling light dot -->
            <div
              class="tl-traveling-dot absolute left-1/2 -translate-x-1/2 w-1.5 h-8 rounded-full bg-gradient-to-b from-transparent via-white to-transparent opacity-60"
            />
          </div>
          ...
          >
            ...
            >
              ...
              <div
                class="absolute left-6 md:left-1/2 -translate-x-1/2 z-10 mt-6"
              >
                <div
                  class="tl-dot-wrap relative flex items-center justify-center"
                >
                  <!-- Outer ping ring -->
                  <span
                  ...
                  <!-- Middle glow ring -->
                  <span
                    class="absolute w-5 h-5 rounded-full bg-brand-violet/20 dark:bg-brand-cyan/20 tl-glow-ring"
                    :style="{ animationDelay: i * 0.5 + 's' }"
                  />
                  <!-- Core dot -->
                  <span
                    class="relative w-4 h-4 rounded-full bg-gradient-to-br from-brand-violet to-brand-cyan shadow-lg shadow-brand-violet/30 dark:shadow-brand-cyan/30 tl-core-dot"
                  />
                  <!-- Inner sparkle -->
                  <span
                    class="absolute w-1.5 h-1.5 rounded-full bg-white/80 top-1 left-1 tl-sparkle"
                  />
                </div>
              </div>
              ...
              <!-- Card -->
              <div
                class="flex-1 md:w-[calc(50%-2rem)]"
              ...
              >
                ...
                >
                  ...
                  <div
                    class="hidden md:block absolute top-8 w-8 h-px"
                    :class="
                      i % 2 === 0
                  ...
                  <!-- Corner accent -->
                  <div
                    class="absolute top-0 right-0 w-16 h-16 overflow-hidden rounded-tr-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                  >
                    <div
                      class="absolute -top-8 -right-8 w-16 h-16 bg-gradient-to-br from-brand-violet/10 to-brand-cyan/10 rotate-45"
                    />
                  </div>
                  <!-- Step number -->
                  <div
                    class="absolute -top-3 -left-3 w-7 h-7 rounded-full bg-gradient-to-br from-brand-violet to-brand-cyan flex items-center justify-center text-white text-[10px] font-bold shadow-md tl-step-badge opacity-0 group-hover:opacity-100 transition-all duration-300 group-hover:scale-110"
                  >
                  ...
                  <h3
                    class="text-base font-sans font-bold text-gray-900 dark:text-white mb-2 group-hover:text-brand-violet dark:group-hover:text-brand-cyan transition-colors duration-300"
                  >
                    {{ item.title }}
                  </h3>
                  <p
                    class="text-sm text-gray-700 dark:text-gray-400 leading-relaxed"
                  >
                    {{ item.description }}
                  </p>
                  <!-- Bottom progress bar on hover -->
                  <div
                    class="absolute bottom-0 left-0 right-0 h-0.5 rounded-b-2xl overflow-hidden"
                  >
                    <div
                      class="tl-progress-bar h-full bg-gradient-to-r from-brand-violet to-brand-cyan w-0 group-hover:w-full transition-all duration-700 ease-out"
                    />
                  </div>
                </div>
              </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          >
            ...
            <h3
              class="text-base font-sans font-bold text-gray-900 dark:text-white mb-2 group-hover:text-brand-violet dark:group-hover:text-brand-cyan transition-colors"
            >
              {{ item.title }}
            </h3>
...
const values = [
  {
    ...
    description:
      "We embrace new technologies and creative approaches, always pushing boundaries to solve problems in unique ways.",
  },
  {
    ...
    title: "Quality Code",
    description:
      "Clean, maintainable, and well-documented code is at the heart of everything we build. We follow best practices always.",
  },
  {
    ...
    description:
      "We believe in the power of teamwork. Every member brings unique skills that combine to create something greater.",
  },
  {
    ...
    description:
      "Technology should serve the community. We contribute to Cambodia's digital growth and inspire future developers.",
  },
  {
    ...
    description:
      "As students, learning is in our DNA. We constantly explore new technologies, share knowledge, and grow together.",
  },
  {
    ...
    title: "Open Source",
    description:
      "We believe in giving back. Open source is part of our culture — sharing code, tools, and knowledge with the world.",
  },
];
...
const timeline = [
  {
    ...
    title: "The Idea",
    description:
      "Four IT engineering students at Norton University started discussing forming a team to build real-world projects together.",
  },
  {
    date: "Mid 2024",
    title: "Team Formation",
    description:
      "Kalapak Code Team was officially formed. We chose our name to represent packaging knowledge through code.",
  },
  {
    date: "Late 2024",
    title: "First Projects",
    description:
      "We began building our first collaborative projects, learning modern tech stacks and agile workflows.",
  },
  {
    date: "2025",
    title: "Growing & Shipping",
    description:
      "Launched our team website, expanded our portfolio, and started contributing to the Cambodian tech community.",
  },
  {
    date: "The Future",
    title: "Scaling Up",
    description:
      "Aiming to take on larger projects, welcome new members, and make an even bigger impact in the tech scene.",
  },
];
...
const differentiators = [
  {
    ...
    description:
      "Fresh perspectives and cutting-edge knowledge straight from university.",
  },
  {
  ...
  },
  {
    ...
    title: "Modern Stack",
    description:
      "Vue, Laravel, Flutter, Docker — always using the latest and best tools.",
  },
  {
    ...
    title: "100% Passion",
    description:
      "We code because we love it. Every project is a labor of love and learning.",
  },
];
</script>
...
@keyframes tlCorePulse {
  ...
  100% {
    transform: scale(1);
    box-shadow: 0 0 0 0 rgba(123, 47, 255, 0.3);
  }
  50% {
    transform: scale(1.1);
    box-shadow: 0 0 12px 4px rgba(123, 47, 255, 0.15);
  }
}
@keyframes tlSparkle {
  0%,
