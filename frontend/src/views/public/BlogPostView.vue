  ...
  <div class="blog-post-page">
    ...
    <template v-else-if="post">
      ...
      <section class="relative min-h-[45vh] sm:min-h-[55vh] flex items-end overflow-hidden">
        ...
        <!-- Back button -->
        <router-link to="/blog" class="absolute top-4 left-4 sm:top-6 sm:left-6 z-20 inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium text-white/90 bg-white/10 backdrop-blur-md border border-white/10 hover:bg-white/20 transition-all duration-300">
        ...
        <div class="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 pb-8 sm:pb-12 pt-24 sm:pt-32">
          ...
          <!-- Meta bar -->
            ...
            <router-link
              ...
              class="flex items-center gap-2.5 rounded-full hover:bg-white/10 transition-colors -m-1 p-1"
            >
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
          <div class="grid lg:grid-cols-[1fr_320px] gap-6 lg:gap-10">
            ...
            <article data-aos="fade-up"
              class="min-w-0 rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm p-4 sm:p-8 md:p-12 overflow-hidden">
            ...
            <aside class="min-w-0 space-y-6 lg:sticky lg:top-24 lg:self-start">
              ...
              <router-link
                ...
                class="rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm p-6 text-center overflow-hidden block hover:border-black/[0.16] dark:hover:border-white/20 transition-colors"
              >
              ...
              <div
                v-else
                data-aos="fade-left" data-aos-delay="100"
                class="rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm p-6 text-center overflow-hidden"
              >
                <div class="w-16 h-16 rounded-full overflow-hidden ring-3 ring-brand-violet/20 dark:ring-brand-cyan/20 mx-auto mb-3">
                  <img v-if="post.author?.avatar" :src="post.author.avatar" :alt="post.author.name" class="w-full h-full object-cover" />
                  <div v-else class="w-full h-full bg-gradient-brand flex items-center justify-center text-white text-2xl font-bold">{{ post.author?.name?.charAt(0) }}</div>
              ...
              <div data-aos="fade-left" data-aos-delay="200"
                class="rounded-2xl border border-black/[0.08] dark:border-white/[0.08] bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm p-6 overflow-hidden">
              ...
              <div data-aos="fade-left" data-aos-delay="300"
                ...
                <div class="grid grid-cols-5 gap-1.5 mb-3">
                  ...
                  <a :href="`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-black/[0.08] dark:border-white/[0.08] text-gray-500 dark:text-gray-400 hover:bg-[#1877F2]/10 hover:border-[#1877F2] hover:text-[#1877F2] transition-all duration-300">
                  ...
                  <a :href="`https://t.me/share/url?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(post.title)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-black/[0.08] dark:border-white/[0.08] text-gray-500 dark:text-gray-400 hover:bg-[#229ED9]/10 hover:border-[#229ED9] hover:text-[#229ED9] transition-all duration-300">
                  ...
                  <a :href="`https://wa.me/?text=${encodeURIComponent(post.title + '\n' + currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-black/[0.08] dark:border-white/[0.08] text-gray-500 dark:text-gray-400 hover:bg-[#25D366]/10 hover:border-[#25D366] hover:text-[#25D366] transition-all duration-300">
                  ...
                  <a :href="`https://twitter.com/intent/tweet?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(post.title)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-black/[0.08] dark:border-white/[0.08] text-gray-500 dark:text-gray-400 hover:bg-gray-900/10 dark:hover:bg-white/10 hover:border-gray-800 dark:hover:border-gray-300 hover:text-gray-900 dark:hover:text-white transition-all duration-300">
                  ...
                  <a :href="`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-black/[0.08] dark:border-white/[0.08] text-gray-500 dark:text-gray-400 hover:bg-[#0A66C2]/10 hover:border-[#0A66C2] hover:text-[#0A66C2] transition-all duration-300">
                ...
                <button @click="copyLink"
                  class="w-full flex items-center justify-center gap-2 px-3 py-2.5 rounded-full text-xs font-medium border transition-all duration-300"
                  :class="copied
                    ? 'bg-green-500/10 border-green-500 text-green-600 dark:text-green-400'
                    : 'border-gray-200 dark:border-dark-500 text-gray-600 dark:text-gray-400 hover:border-black/[0.16] dark:hover:border-white/20 hover:text-brand-violet dark:hover:text-brand-cyan'">
      ...
      <section class="pb-24 relative z-10">
        <div class="max-w-4xl mx-auto px-4">
          <div data-aos="fade-up" class="flex items-center justify-center">
            <router-link to="/blog" class="inline-flex items-center gap-2 px-6 py-3 rounded-full text-sm font-medium border border-black/[0.08] dark:border-white/[0.08] text-gray-600 dark:text-gray-400 hover:border-black/[0.16] dark:hover:border-white/20 hover:text-brand-violet dark:hover:text-brand-cyan bg-white/60 dark:bg-dark-800/60 backdrop-blur-sm transition-all duration-300 hover:-translate-y-0.5">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.5 19.5L3 12m0 0l7.5-7.5M3 12h18" /></svg>
