              ...
              <div data-aos="fade-left" data-aos-delay="300"
                ...
                <div class="grid grid-cols-5 gap-1.5 mb-3">
                  ...
                  <a :href="`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-gray-200 dark:border-dark-500 text-gray-500 dark:text-gray-400 hover:bg-[#1877F2]/10 hover:border-[#1877F2] hover:text-[#1877F2] transition-all duration-300">
                  ...
                  <a :href="`https://t.me/share/url?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(post.title)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-gray-200 dark:border-dark-500 text-gray-500 dark:text-gray-400 hover:bg-[#229ED9]/10 hover:border-[#229ED9] hover:text-[#229ED9] transition-all duration-300">
                  ...
                  <a :href="`https://wa.me/?text=${encodeURIComponent(post.title + '\n' + currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-gray-200 dark:border-dark-500 text-gray-500 dark:text-gray-400 hover:bg-[#25D366]/10 hover:border-[#25D366] hover:text-[#25D366] transition-all duration-300">
                  ...
                  <a :href="`https://twitter.com/intent/tweet?url=${encodeURIComponent(currentUrl)}&text=${encodeURIComponent(post.title)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-gray-200 dark:border-dark-500 text-gray-500 dark:text-gray-400 hover:bg-gray-900/10 dark:hover:bg-white/10 hover:border-gray-800 dark:hover:border-gray-300 hover:text-gray-900 dark:hover:text-white transition-all duration-300">
                  ...
                  <a :href="`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}`"
                    ...
                    class="flex flex-col items-center gap-1 py-2.5 rounded-full border border-gray-200 dark:border-dark-500 text-gray-500 dark:text-gray-400 hover:bg-[#0A66C2]/10 hover:border-[#0A66C2] hover:text-[#0A66C2] transition-all duration-300">
