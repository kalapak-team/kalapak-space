      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6">
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          <div v-for="(info, i) in contactInfo" :key="i"
            ...
            <div class="w-12 h-12 rounded-full mx-auto mb-4 flex items-center justify-center transition-transform duration-500 group-hover:scale-110"
              :class="info.bgClass">
        ...
        <div class="grid lg:grid-cols-[1fr_400px] gap-8 lg:gap-10">
          ...
          <div class="rounded-2xl sm:rounded-3xl border border-gray-200 dark:border-dark-600 bg-white/92 dark:bg-dark-800/60 backdrop-blur-sm overflow-hidden">
            ...
            <form v-else @submit.prevent="handleSubmit" data-aos="fade-up" class="p-5 sm:p-8 md:p-10 space-y-5 sm:space-y-6">
              ...
              <p v-if="error" class="text-sm text-red-500 text-center px-4 py-2 rounded-full bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                {{ error }}
              </p>
            </form>
          </div>
            ...
            <div data-aos="fade-left" data-aos-delay="200"
              ...
              <div class="space-y-2">
                <a v-for="social in socials" :key="social.name"
                  ...
                  class="group flex items-center gap-3 px-4 py-3 rounded-full border border-gray-200 dark:border-dark-600 hover:border-brand-violet/30 dark:hover:border-brand-cyan/30 hover:bg-brand-violet/5 dark:hover:bg-brand-cyan/5 transition-all duration-300">
                  <div class="w-8 h-8 rounded-full flex items-center justify-center" :class="social.bgClass">
